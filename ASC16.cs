...
namespace nifanfa.Font
{
    public static class ASC16
    {
        ...
        public static void DrawACSIIString(this Canvas canvas, string s, int x, int y)
        {
            //ASCII
                ...
                for (int c = 0; c < lines[l].Length; c++)
                {
                    ...
                    for (int i = 0; i < 16; i++)
                    {
                        for (int j = 0; j < 8; j++)
                        {
                            ...
                            {
                                canvas.DrawPoint(new Pen(Color.White), (x + j) + (c * 8), y + i + (l * 16));
                            }
                            else
                            {
                                canvas.DrawPoint(new Pen(Color.Black), (x + j) + (c * 8), y + i + (l * 16));
                            }
                        }
                    }
                }
